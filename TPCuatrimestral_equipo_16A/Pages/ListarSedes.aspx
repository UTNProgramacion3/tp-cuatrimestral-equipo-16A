    ...
    <div class="row g-4 d-flex justify-content-center">
        <div class="col-md-6">
            ...
            <div>
                ...
                <div class="mb-3">
                    <asp:Button class="btn btn-dark" Text="Modificar" runat="server" ID="btnModificar" data-bs-toggle="modal" data-bs-target="#modalSede" OnClick="btnModificar_Click" OnClientClick="return false;" />
                </div>
                <div class="modal fade" id="modalSede" tabindex="-1" aria-labelledby="modalSedeLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalSedeLabel">Modificar Sede</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <label class="form-label fw-bold" runat="server">Nombre Sede</label>
                                <asp:TextBox ID="txtNombreSede" runat="server" CssClass="form-control" required="True"></asp:TextBox>
                                <br />
                                <label class="form-label fw-bold" runat="server">Calle</label>
                                <asp:TextBox ID="txtCalleSede" runat="server" CssClass="form-control" required="True"></asp:TextBox>
                                <br />
                                <label class="form-label fw-bold" runat="server">Numero</label>
                                <asp:TextBox ID="txtNumero" runat="server" CssClass="form-control" required="True"></asp:TextBox>
                                <br />
                                ...
                                <asp:TextBox ID="txtLocalidad" runat="server" CssClass="form-control" required="True"></asp:TextBox>
                                <br />
                                <label class="form-label fw-bold" runat="server">Provincia</label>
                                <asp:TextBox ID="txtProvincia" runat="server" CssClass="form-control" required="True"></asp:TextBox>
                                <br />
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:Button ID="btnModificarSede" runat="server" CssClass="btn btn-dark" Text="Modificar" OnClick="btnModificarSede_Click" />
                            </div>
                        </div>
                    </div>
                </div>
