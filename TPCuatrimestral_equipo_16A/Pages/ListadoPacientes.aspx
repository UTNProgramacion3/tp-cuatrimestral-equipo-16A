<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="ListadoPacientes.aspx.cs" Inherits="TPCuatrimestral_equipo_16A.Pages.ListadoPacientes" %>
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                ...
                <asp:DropDownList ID="ddlObraSocial" runat="server" CssClass="form-control">
                    <asp:ListItem Text="Todas" Value="0" />
                </asp:DropDownList>
            </div>
            <div class="col-md-3 d-flex align-items-end">
                <asp:Button ID="btnFiltrar" runat="server" Text="Filtrar" CssClass="btn btn-primary" OnCick="" />
            </div>
        </div>
