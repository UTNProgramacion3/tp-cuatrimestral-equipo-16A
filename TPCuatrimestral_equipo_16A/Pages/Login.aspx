        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <div class="card-login">
                    ...
                    <asp:Label ID="lblUsername" runat="server" Text="Ingresa tu nombre de usuario." CssClass="label"></asp:Label>
                    <asp:TextBox ID="txtUsername" runat="server" CssClass="textbox" oninput="toggleFields()"></asp:TextBox>
                    ...
                    <asp:Button ID="btnLogin" CssClass="login-btn" Text="Ingresar!" runat="server" Enabled="false"/>
